...
export default function ChatBot() {
  ...
  function handleSend(e) {
    ...
    setTimeout(() => {
      ...
      if (idx !== -1) addMsg('bot', faq[idx].a)
      else addMsg('bot', "Je n'ai pas trouvé de réponse à votre question. Vous pouvez nous contacter directement par email (info@elitehospitality.consulting) ou téléphone (+229 01 40 14 64 91).")
      setShowQuick(true)
    }, 500)
  }
